...
const Dashboard = () => {
    ...
    return (
        <Fragment>
            ...
            {/* Supervisors and Recruiters Lists */}
            <div className="grid grid-cols-12 gap-x-6 mb-6">
                {/* Supervisors List */}
                <div className="xl:col-span-6 col-span-12">
                    <div className="box">
                        <div className="box-header justify-between">
                            <div>
                                <div className="box-title">Supervisors</div>
                                {recruitersAndSupervisorsCounts && (
                                    <div className="text-sm text-[#8c9097] dark:text-white/50">
                                        Total: {recruitersAndSupervisorsCounts.totalSupervisors} | 
                                        Verified: {recruitersAndSupervisorsCounts.verifiedSupervisors}
                                    </div>
                                )}
                            </div>
                            <button
                        ...
                        <div className="box-body">
                            {!supervisors || supervisors.length === 0 ? (
                                <div className="text-center py-8">
                                    <p className="text-muted">No supervisors registered yet.</p>
                                </div>
                            ) : (
                                <div className="table-responsive">
                                    <table className="table min-w-full whitespace-nowrap table-hover border">
                                        ...
                                        <tbody>
                                            {supervisors.map((supervisor) => (
                                                <tr key={supervisor.id} className="border-y border-inherit border-solid dark:border-defaultborder/10">
                                                    <td>
                                                    ...
                                                    <td>
                                                        {supervisor.phoneNumber ? (
                                                            <div className="text-sm">
                                                                {supervisor.countryCode || ''}{supervisor.phoneNumber}
                                                            </div>
                                                        ) : (
                                                    ...
                                                    <td>
                                                        {supervisor.isEmailVerified ? (
                                                            <span className="badge bg-success/10 text-success">Verified</span>
                                                        ) : (
                                                            <span className="badge bg-warning/10 text-warning">Unverified</span>
                                                        )}
                                                    </td>
                                                    <td>
                                                        <div className="text-sm text-[#8c9097] dark:text-white/50">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <div className="box">
                        <div className="box-header justify-between">
                            <div>
                                <div className="box-title">Recruiters</div>
                                {recruitersAndSupervisorsCounts && (
                                    <div className="text-sm text-[#8c9097] dark:text-white/50">
                                        Total: {recruitersAndSupervisorsCounts.totalRecruiters} | 
                                        Verified: {recruitersAndSupervisorsCounts.verifiedRecruiters}
                                    </div>
                                )}
                            </div>
                            <button
                        ...
                        <div className="box-body">
                            {!recruiters || recruiters.length === 0 ? (
                                <div className="text-center py-8">
                                    <p className="text-muted">No recruiters registered yet.</p>
                                </div>
                            ) : (
                                <div className="table-responsive">
                                    <table className="table min-w-full whitespace-nowrap table-hover border">
                                        ...
                                        <tbody>
                                            {recruiters.map((recruiter) => (
                                                <tr key={recruiter.id} className="border-y border-inherit border-solid dark:border-defaultborder/10">
                                                    <td>
                                                        <div className="font-semibold">{recruiter.name}</div>
                                                    </td>
                                                    <td>
                                                        <div className="text-sm">{recruiter.email}</div>
                                                    </td>
                                                    <td>
                                                        {recruiter.phoneNumber ? (
                                                            <div className="text-sm">
                                                                {recruiter.countryCode || ''}{recruiter.phoneNumber}
                                                            </div>
                                                        ) : (
                                                            <span className="text-muted">N/A</span>
                                                        )}
