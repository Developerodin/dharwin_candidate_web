...
import { addSupervisor } from '@/shared/lib/supervisors';
...
const AddSupervisor = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await Swal.fire({
                icon: 'success',
                title: 'Success!',
                text: 'Supervisor has been created successfully.',
                confirmButtonText: 'OK'
            });
    ...
    return (
        <Fragment>
            <Seo title="Add Supervisor" />
            <Pageheader currentpage="Add Supervisor" activepage="Supervisors" mainpage="Add Supervisor" />
