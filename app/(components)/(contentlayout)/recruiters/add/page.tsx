...
import { addRecruiter } from '@/shared/lib/recruiters';
...
const AddRecruiter = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await Swal.fire({
                icon: 'success',
                title: 'Success!',
                text: 'Recruiter has been created successfully.',
                confirmButtonText: 'OK'
            });
            ...
            await Swal.fire({
                icon: 'error',
                title: 'Error',
                text: error?.response?.data?.message || error?.message || 'Failed to create recruiter. Please try again.',
                confirmButtonText: 'OK'
            });
        } finally {
            setLoading(false);
    ...
    return (
        <Fragment>
            ...
            <Pageheader currentpage="Add Recruiter" activepage="Recruiters" mainpage="Add Recruiter" />
